...
export const queryFace = async (req, res) => {
    ...
    const student = await Student.findById(bestMatch._label).select('name studentNumber isBlocked department degree section yearLevel updated SY dateOfBirth pfp');
    if (!student) {
